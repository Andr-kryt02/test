...
class PlayerSongList: ViewWithXib {
    ...
    override func initUI() {
		...
		collectionView.register(UINib(nibName: RoundedPictureCollectionViewCell.className, bundle: nil), forCellWithReuseIdentifier: RoundedPictureCollectionViewCell.className)
		collectionView.decelerationRate = 200
	...
	override func layoutSubviews() {
		...
		insets.left = self.frame.size.width * 0.25
    ...
    fileprivate func updateCellSize(cell: UICollectionViewCell) {
        ...
        let expansionValue: CGFloat = 0.3
        let transformValue = ((0.8 + expansionValue) -
